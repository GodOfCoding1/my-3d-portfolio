...
Ammo().then((Ammo) => {
    ...
    //create Ammo.js body to add solid mass to "Madhav Floyd Software Engineer"
    function madhavRajeevWords(x, y, z) {
        const boxScale = { x: 52, y: 3, z: 2 };
        let quat = { x: 0, y: 0, z: 0, w: 1 };
        let mass = 0; //mass of zero = infinite mass
    ...
    //loads text for Madhav Floyd Mesh
    function loadMadhavText() {
        ...
        text_loader.load("./src/jsm/Roboto_Regular.json", function(font) {
            ...
            var geometry = new THREE.TextGeometry("Madhav Rajeev", {
                font: font,
                size: 3,
                height: 0.5,
                curveSegments: 12,
            ...
            xMid = -0.5 * (geometry.boundingBox.max.x - geometry.boundingBox.min.x) - 1;
    ...
    function start() {
        ...
        madhavRajeevWords(11.2, 1, -20);
        createTextOnPlane(-70, 0.01, -48, inputText.terpSolutionsText, 20, 40);
        createTextOnPlane(-42, 0.01, -50, inputText.bagholderBetsText, 20, 40);
        ...
        simpleText(64, 0.01, -30, "Roll into this wall", 1.5);
